                    ...
                    {employees.map((item, i)=>(
                        <Table.Row>
                            <Table.Cell>
                                ...
                                {(((pageOption[0].currentPage*50)-49)+i)}
                            </Table.Cell>
                            <Table.Cell>
                            ...
                            <Table.Cell>
                                    <Button.Group basic vertical labeled icon>
                                            {item.takeAction?
                                                <Button icon='file' content='Take Action' title="Take Action" onClick={() => {dispatch({ type: 'OPEN_MODAL', dimmer: 'blurring' });TakeActionHandler(item.apiID,item.subject,item.concern)}} />
                                            :""
                                            }
                                            {item.otherTools?
